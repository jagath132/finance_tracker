import{r as u}from"./vendor-UbVtIYU6.js";var Ev={exports:{}},ya={};/**
 * @license React
...
`,Va=16,Nne=({reverseOrder:t,position:a="top-center",toastOptions:o,gutter:n,children:c,toasterId:r,containerStyle:i,containerClassName:d})=>{let{toasts:s,handlers:y}=Koe(o,r);return u.createElement("div",{"data-rht-toaster":r||"",style:{position:"fixed",zIndex:9999,top:Va,left:Va,right:Va,bottom:Va,pointerEvents:"none",...i},className:d,onMouseEnter:y.startPause,onMouseLeave:y.endPause},s.map(h=>{let l=h.position||a,p=y.calculateOffset(h,{reverseOrder:t,gutter:n,defaultPosition:a}),k=vne(l,p);return u.createElement(gne,{id:h.id,key:h.id,onHeightUpdate:y.updateHeight,className:h.visible?xne:"",style:k},h.type==="custom"?Tv(h.message,h):c?c(h):u.createElement(fne,{toast:h,position:l}))}))},$ne=z;export{A4 as $,un as A,Hi as B,Sd as C,Ws as D,V2 as E,Al as F,ap as G,Eu as H,Gu as I,sm as J,L1 as K,uk as L,v5 as M,zy as N,Ch as O,a8 as P,Nh as Q,R8 as R,MM as S,Tf as T,_g as U,Je as V,Q8 as W,xv as X,u8 as Y,Y0 as Z,wne as _,ot as a,H7 as a0,cr as a1,Nne as b,n5 as c,cM as d,i5 as e,Pf as f,Xo as g,Ine as h,Jf as i,te as j,Sm as k,er as l,Cne as m,f0 as n,xy as o,on as p,F as q,Sf as r,PM as s,Hy as t,nr as u,hg as v,eh as w,Pe as x,_s as y,$ne as z};
