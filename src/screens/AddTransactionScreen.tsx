        ...
        >
          ...
          >
            <div className="flex-shrink-0 p-4 border-b border-light-border dark:border-dark-border flex items-center justify-between">
              ...
              <button
                onClick={onClose}
                className="p-2 rounded-full hover:bg-light-secondary dark:hover:bg-dark-primary"
              >
                <X
                  size={24}
            ...
            <form
              ...
              className="flex-grow flex flex-col p-4 sm:p-6 overflow-y-auto"
            >
              ...
              <div className="mb-8">
                <label className="block text-sm font-medium text-light-text-secondary dark:text-dark-text-secondary mb-2 text-center">
                  Amount
                </label>
