...
const AddCategoryForm: React.FC<{
  ...
  return (
    <form
      ...
      className="bg-light-secondary dark:bg-dark-secondary p-4 rounded-lg mt-4 space-y-4"
    >
      <input
...
const CategoriesScreen: React.FC = () => {
  ...
  const searchedCategories = tabFilteredCategories.filter((cat) =>
    ...
    <div className="min-h-screen p-4 sm:p-6 lg:p-8 pb-20">
      <header className="mb-6 flex justify-between items-center">
        ...
        <button
          ...
          className="bg-brand-green text-white p-2 rounded-full shadow-lg"
        >
          <Plus size={20} />
        </button>
      </header>
            ...
            {searchedCategories.map((cat) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold break-words truncate max-w-[150px] sm:max-w-xs">
                    {cat.name}
                  </span>
                </div>
              </motion.div>
