...
const ExportDataScreen: React.FC = () => {
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            const filename = `cointrail-export-${new Date().toISOString().split('T')[0]}.csv`;
    ...
    return (
        <div className="min-h-screen bg-dark-primary text-white p-4 sm:p-6">
            ...
            <div className="bg-dark-secondary p-6 rounded-2xl text-center">
                <p className="text-gray-400 mb-4">Export all your transaction data into a single CSV file.</p>
                <div className="mt-6">
                    <Button onClick={handleExport} isLoading={isExporting || transactionsLoading}>
