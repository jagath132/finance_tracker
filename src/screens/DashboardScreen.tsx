...
const SummaryCard = React.memo<SummaryCardProps>(
  ({ title, amount, change, icon, colorClass, isBalance = false }) => (
    <motion.div
    ...
    >
      <div className="flex justify-between items-start">
        <span className="text-light-text-secondary dark:text-dark-text-secondary text-sm sm:text-base">
          {title}
        </span>
        {icon && (
          <div
      ...
      <header className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 rounded-full bg-light-secondary dark:bg-dark-secondary hover:bg-light-primary dark:hover:bg-dark-primary"
          >
            <LogOut
              size={20}
              className="text-light-text-secondary dark:text-dark-text-secondary"
      ...
      <main>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/transactions" className="text-brand-green text-sm">
              View All
            </Link>
          </div>
          {loading ? (
