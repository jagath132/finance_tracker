...
const SettingsScreen: React.FC = () => {
  ...
  const { deleteAllTransactions, refetch: refetchTransactions } =
    useTransactions();
  const { deleteAllCategories, refetch: refetchCategories } = useCategories();
  ...
  const handleResetData = async () => {
    ...
    try {
      ...
      toast.error("Failed to reset data. Please try again.", { id: toastId });
    } finally {
  ...
  const features = [
    {
      title: "Dashboard",
      description:
        "Overview of your finances with charts and recent transactions.",
      color: "bg-blue-100 dark:bg-blue-900",
      icon: BarChart3,
    },
    {
      title: "Transactions",
      description: "View, add, edit, and manage your financial transactions.",
      color: "bg-green-100 dark:bg-green-900",
      icon: Receipt,
    },
    {
      title: "Categories",
      description: "Organize your transactions into custom categories.",
      color: "bg-yellow-100 dark:bg-yellow-900",
      icon: Tag,
    },
    {
      title: "Search",
      description: "Quickly find specific transactions.",
      color: "bg-purple-100 dark:bg-purple-900",
      icon: Search,
    },
    {
      title: "Import/Export",
      description: "Import transactions from CSV or export your data.",
        ...
        <div className="space-y-8">
          <div>
            ...
            <div className="bg-light-secondary dark:bg-dark-secondary rounded-lg">
              <Link
                to="/profile"
                className="flex items-center justify-between p-4 hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors"
              >
              ...
              {features.map((feature, index) => (
                ...
                >
                  <h3 className="font-semibold flex items-center">
                    <feature.icon size={24} className="mr-2" />
                    {feature.title}
                  </h3>
                  <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
                    {feature.description}
          ...
          <div>
            ...
            <div className="bg-light-secondary dark:bg-dark-secondary rounded-lg">
              <button
                ...
                className="w-full flex items-center justify-between p-4 hover:bg-red-900/20 transition-colors text-brand-red"
              >
                <div className="flex items-center">
          ...
          <div className="bg-light-secondary dark:bg-dark-secondary rounded-lg">
            <button
              ...
              className="w-full flex items-center p-4 hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors text-brand-red"
            >
