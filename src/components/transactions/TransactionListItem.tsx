...
const TransactionListItem: React.FC<TransactionListItemProps> = React.memo(
  ({ transaction, category, onDelete, onClick }) => {
    ...
    const unusedVar = handleDeleteRequest;
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-light-text dark:text-dark-text truncate text-sm sm:text-base">
                  {transaction.description}
                </p>
                <div className="flex items-center mt-1">
                  <span className="text-xs sm:text-sm text-light-text-secondary dark:text-dark-text-secondary truncate">
                    {categoryName}
                  </span>
                  <span className="mx-1 sm:mx-2 text-light-text-secondary dark:text-dark-text-secondary hidden sm:inline">
                    •
                  </span>
